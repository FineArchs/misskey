...
(async () => {
	const globs = await Promise.all([
		...
		glob('src/components/modals/MkAnnouncementDialog.vue'),
		glob('src/components/MkAntennaEditor.vue'),
		glob('src/components/modals/MkAntennaEditorDialog.vue'),
		...
		glob('src/components/modals/MkUserSetupDialog.vue'),
		glob('src/components/modals/MkUserSetupDialog.*.vue'),
		glob('src/components/modals/MkImgPreviewDialog.vue'),
		glob('src/components/MkInstanceCardMini.vue'),
		glob('src/components/MkInviteCode.vue'),
		glob('src/components/MkTagItem.vue'),
		glob('src/components/modals/MkRoleSelectDialog.vue'),
